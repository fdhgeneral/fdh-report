...
(function(){
  ...
  +"<div class=\"h2h-stat-row\">"
    +"<span class=\"h2h-stat-label\">Biggest Win</span>"
    +"<span class=\"h2h-stat-value\">"+(bw.winner||"?")+" +"+bw.margin+" pts "+bwCtx+"</span>"
  +"</div>"

  +"<div class=\"h2h-stat-row\">"
    +"<span class=\"h2h-stat-label\">Streak</span>"
    +"<span class=\"h2h-stat-value\">"+(sk.holder||"?")+" — "+(sk.count||1)+"W</span>"
  +"</div>"

  +"<div class=\"h2h-stat-row\">"
    +"<span class=\"h2h-stat-label\">Closest Game</span>"
    +"<span class=\"h2h-stat-value\">"+(cl.winner||"?")+" +"+(cl.margin||0)+" pts ("+(cl.context||"")+")</span>"
  +"</div>"
+"</div>"
